...
Tarih: 2026-09-12 (v0.18.0). Kaynak: `/root/dev/projects/pocket-agent`. Tek doğruluk kaynağı: `plan.md` (v2).
...
## 4. Test raporu (son yeşil koşu, v0.18.0)
...
- Çıktılar: `apps/android/app/build/outputs/apk/debug/app-debug.apk` + kopya `dist/pocket-agent-0.18.0-debug.apk` (77.8MB v0.18.0 / versionCode 15, debug imzalı; SSHJ+bcprov+icons+mosh 3 ABI + 3 gömülü font dahil; sha256: `8ada45d0…ac53`, tam değer `dist/` ve `/srv/pocket-agent-apk/SHA256SUMS` ile doğrulanır). İndirilebilir sayfa: `http://<vps>:8090/` (`/srv/pocket-agent-apk`, ufw'da 8090 açık).
