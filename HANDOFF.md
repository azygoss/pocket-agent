...
Tarih: 2026-09-13 (v0.21.1). Kaynak: `/root/dev/projects/pocket-agent`. Tek doğruluk kaynağı: `plan.md` (v2).
...
- Çıktılar: `apps/android/app/build/outputs/apk/debug/app-debug.apk` + kopya `dist/pocket-agent-0.21.1-debug.apk` (77.8MB v0.21.1 / versionCode 19, debug imzalı; SSHJ+bcprov+icons+mosh 3 ABI + 3 gömülü font dahil; sha256: `73e304e5…6d27`, tam değer `dist/` ve `/srv/pocket-agent-apk/SHA256SUMS` ile doğrulanır). İndirilebilir sayfa: `http://<vps>:8090/` (`/srv/pocket-agent-apk`, ufw'da 8090 açık).
