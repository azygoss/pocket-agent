...
Tarih: 2026-09-10 (v0.16.0). Kaynak: `/root/dev/projects/pocket-agent`. Tek doğruluk kaynağı: `plan.md` (v2).
...
## 4. Test raporu (son yeşil koşu, v0.16.0)
...
- Çıktılar: `apps/android/app/build/outputs/apk/debug/app-debug.apk` + kopya `dist/pocket-agent-0.16.0-debug.apk` (77.7MB v0.16.0 / versionCode 13, debug imzalı; SSHJ+bcprov+icons+mosh 3 ABI + 3 gömülü font dahil; sha256: `b4a0338e…8654`, tam değer `dist/` içinde `sha256sum` ile doğrulanır). İndirilebilir sayfa: `http://<vps>:8090/` (`/srv/pocket-agent-apk`, ufw'da 8090 açık).
