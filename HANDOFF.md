...
Tarih: 2026-09-13 (v0.24.1). Kaynak: `/root/dev/projects/pocket-agent`. Tek doğruluk kaynağı: `plan.md` (v2).
...
## 4. Test raporu (son yeşil koşu, v0.24.1)
...
- Android: **151 unit test yeşil** (`:app:testDebugUnitTest`, 6 env-gated skip), `lintDebug` 0 hata, `assembleDebug` yeşil.
...
- Çıktılar: `apps/android/app/build/outputs/apk/debug/app-debug.apk` + kopya `dist/pocket-agent-0.24.1-debug.apk` (77.8MB v0.24.1 / versionCode 23, debug imzalı; SSHJ+bcprov+icons+mosh 3 ABI + 3 gömülü font dahil; sha256: `a29640e9…58a7`, tam değer `dist/` ve `/srv/pocket-agent-apk/SHA256SUMS` ile doğrulanır). İndirilebilir sayfa: `http://<vps>:8090/` (`/srv/pocket-agent-apk`, ufw'da 8090 açık).
